...
function startGame() {
    myGamePiece = new component(210,180, "img/m1.png", 64, 129,"image");
    musica = new sound('musica/Super Mario Bros. Z Official Intro (HD).mp3');
    titolo = new component(1200, 480, "img/marioz.svg", 566, 129,"image");
    myBackground = new component(4000, 1200, "img/spazio.png", 0, 0, "background");
    myGameArea.start();
}
