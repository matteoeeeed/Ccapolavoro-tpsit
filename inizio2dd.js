...
function startGame() {
    ...
    musica2 = new sound('musica/java1.mp3');
    ...
    testopunti3 = new component('50px','Consolas','orange',20,943,'text');
    myBackground = new component(2000, 1200, "img/l11.jpg", 0, 0, "background");
    myGameArea.start();
}
