...
function startGame() {
    ...
    boss= new component(330,380,"img/java.png",1535,323,"image");
    ...
    suono16 = new sound('musica/sj.mp3');
    musica = new sound('musica/final.mp3');
...
if(numm==1){
    boss.image.src="img/javav.png";
}
if(numm==2){
    boss.image.src="img/javav2.png";
}
...
for (i = 0; i < fboss3.length; i += 1) {
    ...
    testopunti2.update();
    testopunti3.text="JAVA VAATI:"+myGameArea.vitaboss;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
