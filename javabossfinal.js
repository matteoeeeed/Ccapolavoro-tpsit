...
function startGame() {
    ...
    boss= new component(200,280,"img/java.png",1535,323,"image");
    ...
    suono14 = new sound('musica/a.mp3');
    suono15 = new sound('musica/mc.mp3');
    musica = new sound('musica/javaf.mp3');
    testovita = new component('50px','Consolas','white',42,43,'text');
    ...
    myBackground = new component(0, 0, "img/ljj.png", 0, 0, "background");
    myGameArea.start();
}
...
if(myGameArea.frameNo>308800){
    ...
    if (myGameArea.frameNo == 1 || everyinterval(1888850)) {
 ...
 if(myGameArea.frameNo>50088880){
...
if(myGameArea.frameNo>1999990){
    if (myGameArea.frameNo == 1 || everyinterval(80)) {
        num=Math.floor(Math.random()*270)+100;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        suono12.play();
...
if(myGameArea.frameNo>199999999999){
    if (myGameArea.frameNo == 1 || everyinterval(86)) {
        num=Math.floor(Math.random()*1300)+1100;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>1999999999){
    if (myGameArea.frameNo == 1 || everyinterval(96)) {
...
if(myGameArea.frameNo>1999999999){
    if (myGameArea.frameNo == 1 || everyinterval(97)) {
        num=Math.floor(Math.random()*1300)+1000;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        y2 = myGameArea.canvas.height - num + 500;
        suono12.play();
   ...
   if(myGameArea.frameNo>999999999){
   ...
   if(myGameArea.frameNo>4999999990){
    if (myGameArea.frameNo == 1 || everyinterval(129)) {
        num=Math.floor(Math.random()*470)+100;
        x = myGameArea.canvas.width ;
        y = myGameArea.canvas.height - num;
        y2 = myGameArea.canvas.height - num+100;
   ...
   if(myGameArea.frameNo>509999900){
   ...
   if(myGameArea.frameNo>799999999){
...
if(myGameArea.frameNo>99999990){
if (myGameArea.frameNo == 1 || everyinterval(80)) {
    num=Math.floor(Math.random()*970)+10;
    x = myGameArea.canvas.width -2200;
    y = myGameArea.canvas.height - num;
...
if(myGameArea.frameNo>5999999900){
    if (myGameArea.frameNo == 1 || everyinterval(400)) {
...
if(myGameArea.frameNo>4099999900){
...
if(myGameArea.frameNo>3999999900){
...
if(myGameArea.frameNo>999999990){
...
if(myGameArea.movebossy>300){
if(myGameArea.frameNo == 1 || everyinterval(10)){
    num=Math.floor(Math.random()*950)+10;
    x = myGameArea.canvas.width -300;
    y = myGameArea.canvas.height -numb2;
    suono13.play();
    fboss2.push(new component(40,40,"img/fire.png",x,y,"image"));
}
...
if(myGameArea.frameNo == 1 || everyinterval(60)){
    ...
    y = myGameArea.canvas.height -numb2;
    suono14.play();
    fboss3.push(new component(100,100,"img/fireb.png",x,y,"image"));

}
}

if(myGameArea.vitaboss<1000){
if(myGameArea.frameNo == 1 || everyinterval(10)){
    num=Math.floor(Math.random()*950)+10;
    x = myGameArea.canvas.width -300;
    y = myGameArea.canvas.height -numb2;
...
if(myGameArea.vitaboss<4900){
 numm=Math.floor((Math.random() * 2) + 1);
if(numm==1){
    boss.image.src="img/javas.png";
}
if(numm==2){
    boss.image.src="img/javas2.png";
}

}

 if(ballmario.crashWith(boss)){ 
    suono2.play();
     myGameArea.vitaboss-=10;
 }
 ...
 if(myGameArea.vitaboss<0){ 
     window.location.href="javabossfinall.html";  
 }
...
for (i = 0; i < fboss3.length; i += 1) {
    ...
    testopunti2.update();
    testopunti3.text="JAVA:"+myGameArea.vitaboss;
    testopunti3.update();
    monetap.update();
    myGamePiece.newPos();
    myGamePiece.update();
